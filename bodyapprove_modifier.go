...
func init() {
	parse.Register("bodyccapprove.Modifier", modifierFromJSON)
}
...
type Request struct {
	...
	CreditCard        *CreditCard    `xml:"creditCard" json:"creditCard"`
	AdverseAction     *AdverseAction `xml:"adverseAction" json:"adverseAction"`
}

type CreditCard struct {
	Type      string  `xml:"type" json:"type"`
	MaxLimit  float32 `xml:"maxLimit" json:"maxLimit"`
	CashLimit float32 `xml:"cashLimit" json:"cashLimit"`
}
